...
public class SimCardUtils {
    ...
    public static String getSign() {
        return MD5Utils.getMD5Code("appKey=" + APP_KEY + "&timeStamp=" + DateUtils.DATE_FORMAT.format(new Date()) + "&userName=" + USER_NAME + "&appSecret=" + APP_SECRET);
    }
...
//    }
    ...
    public static Map<String, String> getBody() {
        ...
        body.put("timeStamp", DateUtils.DATE_FORMAT.format(new Date()));
